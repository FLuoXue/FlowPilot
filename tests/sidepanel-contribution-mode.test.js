...
test('sidepanel removes contribution mode runtime UI but still loads the module before sidepanel bootstrap', () => {
  ...
  assert.doesNotMatch(html, /id="btn-start-contribution"/);
  assert.doesNotMatch(html, /id="btn-exit-contribution-mode"/);
